...
*/
#ifndef TESTFS_CHANGESTATE_H
#define TESTFS_CHANGESTATE_H

#define TESTFS_FILECHANGED_NONE		0
#define TESTFS_FILECHANGED_FILE		1
#define TESTFS_FILECHANGED_METADATA	2
