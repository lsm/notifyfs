...
int notifyfs_options_output_proc(void *data, const char *arg, int key, struct fuse_args *outargs)
{
	...
	case KEY_HELP:
		...
		"    -o access=NUMBER       set accessmode (0=no check,1=root has access,2=check client)\n"
		"    -o testmode=NUMBER     set testmode (0=no test, default, 1=test, allow any client to set a watch without action)\n"
		"\n"
		"FUSE options:\n"
